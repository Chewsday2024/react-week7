...
import { filterImages, getInputValue, getModalMove, setInputValue, uploadPic } from "./modalSlice";
import { createProduct, delProduct, editProduct } from "../backstageCRUD_Slice";
...
function Modal () {
  ...
  const modalMove = useSelector(getModalMove);
          ...
          <div className="modal-content border-0">
                  ...
                  <div className="mb-2">
                    <div className="mb-5">
                      ...
                      <input
                        ...
                        id="fileInput"
                        name='uploadPic'
                        onChange={(e) => e.target.files[0] && dispatch(uploadPic(e.target.files[0]))}
                      />
                    </div>
                  ...
                  <div className='d-flex'>
                    ...
                    {inputValue.imageUrl 
                      ? <button
                          ...
                          onClick={() => dispatch(setInputValue({ del: 'del' }))}
                          >
                            刪除圖片
                        </button> 
                      : null}
                    ...
                    <div className='row row-cols-1 gap-2'>
                      {inputValue.imagesUrl?.map((pic, index) => 
                        <div className='col' key={index}>
                          ...
                          <button
                            className="btn btn-outline-danger btn-sm w-100"
                            onClick={() => dispatch(filterImages(pic))}>
                              刪除圖片
                          </button>
                        </div>)
                      }
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => {
                modalMove === 'create' ? dispatch(createProduct())
